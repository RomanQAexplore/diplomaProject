...
* Оправить форму,
* Получить сообщение: "Ошибка! Банк отказал в проведении операции".
...
* Оправить форму,
* Получить сообщение об ошибке "Неверный формат ввода. Укажите данные как на карте".
...
* Оправить форму,
* Не проходит валидация поля "месяц". Сообщение "Поле обязательно для заполнения".
...
* Оправить форму,
* Не проходит валидация поля "месяц". Сообщение "Неверный формат ввода. Укажите данные как на карте".
...
* Оправить форму,
* Не проходит валидация поля "год". Сообщение "Поле обязательно для заполнения".
...
* Оправить форму,
* Не проходит валидация поля "год". Сообщение "Неверный формат ввода. Укажите данные как на карте"..
...
* Оправить форму,
* Не проходит валидация поля "Владелец". Сообщение "Поле обязательно для заполнения"
...
* Оправить форму,
* Не проходит валидация поля "CVC/CVV". Сообщение "Неверный формат ввода. Укажите данные как на карте"
...
* Оправить форму,
* Не проходит валидация поля "CVC/CVV". Сообщение "Поле обязательно для заполнения".
